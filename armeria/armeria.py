...
class FattureModal(discord.ui.Modal, title='Nuova Fattura Armeria'):
    ordine = discord.ui.TextInput(
        label='Servizio',
        placeholder='100x Proiettili 9mm',
        required=True
    )
...
async def fattura(interaction: discord.Interaction):
    ...
    embed = discord.Embed(
        title="Benvenuto nel sistema di fatture dell'Armeria 578 di Enveart!",
